...
回顾离散随机过程的概率分布. 离散随机过程概率分布的意思是, 比如一台机器连续运转365天后 __坏掉__  和 __继续运转__ 的概率分别是多少, 或者100轮赌博后 __盈亏多少__ 的概率, 又或者说是每个随机路径到终点 __不同位置__ 的概率. 概率分布描述的是经过多个离散步骤之后 __有限结果__ 的概率汇总.
...
- 但是在 __连续随机过程__ 中, __不存在t和t+1__, 那我们也没法描述两个时刻之间变化的概率, 如果把时间区间所有的变化都算完需要做 __无穷多次计算__ , 并且结果不是有限的. 
